const resetWarnings = () => {
	...
	if (document.getElementById('password-warning-tag')) {
		passwordSection.removeChild(document.getElementById('password-warning-tag'));
	}
	...
	if (document.querySelector('#email-signup-warning-tag')) {
		emailSignupSection.removeChild(document.getElementById('email-signup-warning-tag'));
	}
};
